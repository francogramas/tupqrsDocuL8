...
// Admin
        $admin = User::firstOrCreate([ 'name' => 'Administrador del Sistema', 'email' => 'admin@'.$this->dominio, 'password' => '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',]);
        $admin->assignRole('Gerente');
        $admin->assignRole('Ventanilla');

// Lider de vetanilla unica central
        $usuario = User::firstOrCreate(['name' => 'Ventanilla Unica', 'email' => 'ventanilla@'.$this->dominio, 'password' => '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',]);
        $usuario->assignRole('Ventanilla');

// Auxiliar de dependencia
        $auxiliar = User::firstOrCreate(['name' => 'Auxiliar 1', 'email' => 'auxiliar@'.$this->dominio, 'password' => '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',]); // password
        ...
        EmpresaUser::firstOrCreate(['user_id' => $admin->id, 'empresa_id' => $empresa->id,]);
        EmpresaUser::firstOrCreate(['user_id' => $usuario->id, 'empresa_id' => $empresa->id]);
        EmpresaUser::firstOrCreate(['user_id' => $auxiliar->id, 'empresa_id' => $empresa->id,]);
