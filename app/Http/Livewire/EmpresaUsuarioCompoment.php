...
class EmpresaUsuarioCompoment extends Component
{
    ...
    public function edit($id)
    {
        ...
        $this->nit=$eps->nit;
        $this->razonsocial=$eps->razonsocial;
        $this->telefono=$eps->telefono;
        $this->email=$eps->email;
        $this->estado_id = $eps->ciudad->estado->id;
        $this->ciudades=Ciudade::where('estado_id',$this->estado_id)->get();
        $this->ciudad_id=$eps->ciudad_id;
        $this->direccion=$eps->direccion;
        $this->id_eps=$eps->id;
