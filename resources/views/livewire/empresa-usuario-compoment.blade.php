...
<!-- ------------------------------ Modal 1: Borrar dependencia ---------------------------------------- -->
    ...
    <!-- ------------------------------ Modal 2: Asignar Auxlialres y  lider de dependencia ---------------------------------------- -->
    <x-jet-dialog-modal wire:model="modalFormVisible1" >
        ...
        <x-slot name="content">
                ...
                <div class="pt-2">
                    <label for="">
                        @error('jefe') <span class="text-error  block text-xs">{{ $message }}</span> @enderror
                        <input type="checkbox" wire:model.defer="jefe" class="checkbox checkbox-primary" type="text" />
                        <span>Jefe de oficina</span>
                    </label>
                </div>
                @endif
                <div class="pt-2">
                ...
                <div class="mt-4 pt-2 border-2 rounded-lg">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex @if ($seccionU->jefe) font-bold @endif" >
                            {{$seccionU->user->name}}
                            @if ($seccionU->jefe)
