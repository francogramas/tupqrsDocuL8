<div class="px-3 py-3 my-3 mx-2">
    @livewireScripts
    @livewireChartsScripts
    {{-- Be like water. --}}
    @if ($seccion_id>0)
    <div class="flex">
        <div class="grid grid-cols-3 md:grid-cols-6 mr-5 gap-4 font-semibold ">
            <div class="w-42">
                <label class="label" for="">Fecha inicial</label>
                <input type="date" class="w-full" name="" id="" wire:model="fechai">
            </div>
            <div class="w-42">
                <label class="label" for="">Fecha final</label>
                <input type="date" class="w-full" name="" id="" wire:model="fechaf">
            </div>
            <div>
    ...
    <div>
        ...
        @foreach ($series as $serie)
        <div class="mt-10 print:border print:border-black print:block block mx-2">
