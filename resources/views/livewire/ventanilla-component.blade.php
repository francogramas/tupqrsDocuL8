...
@elseif ($etapa == 1)    
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 px-3 py-2">
        ...
        <div>
            <label for="direccion" class="block text-gray-700 text-sm font-bold">Direccion Completa</label>
...
@elseif ($etapa == 2)
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-3 px-3 py-2">                   
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 col-span-5">
        
            <div class="px-2 py-1 cols">
        ...
        <div class="px-2 py-2 col-span-5">
